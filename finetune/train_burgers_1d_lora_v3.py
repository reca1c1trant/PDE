"""
LoRA Finetuning for 1D Burgers using PDEModelV3.
...
from finetune.pde_loss_verified import Burgers1DPDELoss
...
def parse_args():
    parser = argparse.ArgumentParser(description="LoRA Finetuning for 1D Burgers (V3 Model)")
...
def compute_pde_loss(
    ...
    Args:
        ...
        pde_loss_fn: Burgers1DPDELoss instance
    ...
    with torch.autocast(device_type='cuda', enabled=False):
        ...
        total_loss, losses = pde_loss_fn(u, nu=nu.float())
