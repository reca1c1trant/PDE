"""
LoRA Finetuning for APEBench 3D Burgers, periodic).
...
def parse_args():
    parser = argparse.ArgumentParser(description="LoRA Finetuning for APEBench 3D Burgers)")
...
def compute_pde_loss(
    ...
    """
    Compute APEBench Burgers 3D PDE residual loss.
...
def main():
    ...
    pde_loss_fn = APEBenchBurgers3DPDELoss(
        ...
        alpha_2=physics.get('alpha_2', 2.4414e-4),
        beta_1=physics.get('beta_1', 1.5625e-2),
        eq_scales=eq_scales,
